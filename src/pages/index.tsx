...
export const getStaticProps = async () => {
  ...
  const weatherRes = await fetch(
    `https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&units=metric&exclude=${exclude}&appid=6aeda96532830c406fbe405dfadd84db`
  );
  ...
  const pickupRes = await fetch(
    `https://newsapi.org/v2/everything?q=${keyword}&language=jp&sortBy=${sortBy}&pageSize=${pickupPageSize}&apiKey=db4849d109bb4618ae73077bfa60041c`
  );
